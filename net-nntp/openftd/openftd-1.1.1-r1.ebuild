...
SRC_URI="http://openftd.signalrunner.com/openftd-${PV}.tar.bz2"

LICENSE="BSD"
SLOT="0"
KEYWORDS="x86 amd64"
IUSE="firefox gtkhtml dbus spell webkit gnome libnotify"
...
DEPEND=">=sys-libs/zlib-1.1.4
		...
		gnome? ( gnome-base/libgnome gnome-base/libgnomeui )
		dbus? ( sys-apps/dbus )
