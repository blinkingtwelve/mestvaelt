...
HOMEPAGE="http://www.openftd.org"
SRC_URI="http://openftd.mirrors.sebsoft.nl/openftd/openftd-${PV}.tar.bz2"

LICENSE="BSD"
SLOT="0"
KEYWORDS="x86 amd64"
IUSE="firefox gtkhtml dbus spell webkit"
...
DEPEND=">=sys-libs/zlib-1.1.4
		...
		dbus? ( sys-apps/dbus )
		firefox? ( dev-libs/nspr www-client/firefox )
		gtkhtml? ( >=gnome-extra/gtkhtml-3.7 )
		webkit? ( net-libs/webkit-gtk )
		!firefox? ( !gtkhtml? ( net-libs/xulrunner ) )"
...
src_compile() {
	...
	addpredict /usr/$(get_libdir)/xulrunner-1.9.2/components/xpti.dat
	addpredict /usr/$(get_libdir)/xulrunner-1.9.2/components/xpti.dat.tmp
	addpredict /usr/$(get_libdir)/xulrunner-1.9.2/components/compreg.dat.tm
