...
SRC_URI="https://www.djangoproject.com/m/releases/$(get_version_component_range 1-2)/Django-1.4c2.tar.gz"
...
src_install() {
	...
	doins -r django/contrib/admin/static/* || die "doins failed"
